...
<div class="text-center absolute w-full flex justify-center py-5">
    <button
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <a href="#"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Calendario</a>
                    </li>
                    <li>
                        <a href="#"
            ...
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Ejes de trabajo</span>
                    <span
            ...
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Comisiones</span>
                </a>
            </li>
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Ir a PITSA</span>
                </a>
            </li>
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Normativas</span>
                </a>
            </li>
            <li>
